...
class ConnectionManager
{
	...
	{
		return $this->byId( "gestionetudiant_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "gestionetudiant_at_localhost";
		$data["connName"] = "gestionetudiant at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;gestionetudiant;;1"; //currently unused
		
		$this->_connectionsIdByName["gestionetudiant at localhost"] = "gestionetudiant_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "gestionetudiant";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=gestionetudiant;OPTION=3";
		// encription set
		...
		$connectionsData["gestionetudiant_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["controle"] = "gestionetudiant_at_localhost";
		$connectionsIds["cycle"] = "gestionetudiant_at_localhost";
		$connectionsIds["etudiant"] = "gestionetudiant_at_localhost";
		$connectionsIds["filiere"] = "gestionetudiant_at_localhost";
		$connectionsIds["matiere"] = "gestionetudiant_at_localhost";
		$connectionsIds["niveau"] = "gestionetudiant_at_localhost";
		$connectionsIds["note"] = "gestionetudiant_at_localhost";
		$connectionsIds["note Chart"] = "gestionetudiant_at_localhost";
		$connectionsIds["filiere Chart"] = "gestionetudiant_at_localhost";
		$connectionsIds["gestionetudiant_users"] = "gestionetudiant_at_localhost";
