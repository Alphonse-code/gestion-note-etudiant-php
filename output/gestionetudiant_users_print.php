...
require_once("include/gestionetudiant_users_variables.php");
...
$page_layouts["gestionetudiant_users_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "gestionetudiant_users" );
