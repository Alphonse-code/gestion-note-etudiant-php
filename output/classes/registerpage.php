...
class RegisterPage extends RunnerPage
{
	...
	protected function registerNewUser()
	{
		...
		$retval = DoInsertRecord("gestionetudiant_users", $values, $blobfields, $this);
	...
	protected function checkRegisterData( $strUsername, $strPassword, $strEmail )
	{
		...
		{		
			$this->jsSettings['tableSettings'][ $this->tName ]['msg_userError'] = "Nom d'utilisateur"." <i>".$strUsername."</i> "."existe deja. Choisir un autre nom d'utilisateur.";
			$ret = false;
		}
	...
	protected function checkIfUsernameUnique( $strUsername )
	{
		...
		$strSQL = "select count(*) from ". $this->connection->addTableWrappers( "gestionetudiant_users" ) 
