...
class ProjectSettings
{
	...
	*/
	...
	{
		return new ProjectSettings("gestionetudiant_users", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "controle" ] = array( "url" => "controle", "type" => 0 );
	$projectEntitiesReverse[ "controle" ] = "controle";
	$projectEntities[ "cycle" ] = array( "url" => "cycle", "type" => 0 );
	$projectEntitiesReverse[ "cycle" ] = "cycle";
	$projectEntities[ "etudiant" ] = array( "url" => "etudiant", "type" => 0 );
	$projectEntitiesReverse[ "etudiant" ] = "etudiant";
	$projectEntities[ "filiere" ] = array( "url" => "filiere", "type" => 0 );
	$projectEntitiesReverse[ "filiere" ] = "filiere";
	$projectEntities[ "matiere" ] = array( "url" => "matiere", "type" => 0 );
	$projectEntitiesReverse[ "matiere" ] = "matiere";
	$projectEntities[ "niveau" ] = array( "url" => "niveau", "type" => 0 );
	$projectEntitiesReverse[ "niveau" ] = "niveau";
	$projectEntities[ "note" ] = array( "url" => "note", "type" => 0 );
	$projectEntitiesReverse[ "note" ] = "note";
	$projectEntities[ "Dashboard" ] = array( "url" => "Dashboard", "type" => 4 );
	$projectEntitiesReverse[ "Dashboard" ] = "Dashboard";
	$projectEntities[ "note Chart" ] = array( "url" => "note_Chart", "type" => 3 );
	$projectEntitiesReverse[ "note_Chart" ] = "note Chart";
	$projectEntities[ "filiere Chart" ] = array( "url" => "filiere_Chart", "type" => 3 );
	$projectEntitiesReverse[ "filiere_Chart" ] = "filiere Chart";
	$projectEntities[ "gestionetudiant_users" ] = array( "url" => "gestionetudiant_users", "type" => 0 );
	$projectEntitiesReverse[ "gestionetudiant_users" ] = "gestionetudiant_users";
}
