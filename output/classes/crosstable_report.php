...
class CrossTableReport
{
	...
	{					
		...
		return "Groupe X"
			.":<b>".$this->xml_array["totals"][ $fieldNameX ]["label"]."</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."Groupe Y"
			.":<b>".$this->xml_array["totals"][ $fieldNameY ]["label"]."</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."Champ"
			.":<b>".$this->xml_array["totals"][ $fieldName ]["label"]."</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."Fonction de regroupement"
	...
	public function isProjectDB()
	{
		...
		$isDB = false;
		if("controle" == $this->xml_array['tables'][0])
			$isDB = true;
		if("cycle" == $this->xml_array['tables'][0])
			$isDB = true;
		if("etudiant" == $this->xml_array['tables'][0])
			$isDB = true;
		if("filiere" == $this->xml_array['tables'][0])
			$isDB = true;
		if("matiere" == $this->xml_array['tables'][0])
			$isDB = true;
		if("niveau" == $this->xml_array['tables'][0])
			$isDB = true;
		if("note" == $this->xml_array['tables'][0])
			$isDB = true;
		...
		if("filiere" == $this->xml_array['tables'][0])
			$isDB = true;
		if("gestionetudiant_users" == $this->xml_array['tables'][0])
			$isDB = true;
		return $isDB;
	}
