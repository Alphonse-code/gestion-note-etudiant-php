...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("controle" == $this->chrt_array['tables'][0])
			return true;
		if("cycle" == $this->chrt_array['tables'][0])
			return true;
		if("etudiant" == $this->chrt_array['tables'][0])
			return true;
		if("filiere" == $this->chrt_array['tables'][0])
			return true;
		if("matiere" == $this->chrt_array['tables'][0])
			return true;
		if("niveau" == $this->chrt_array['tables'][0])
			return true;
		if("note" == $this->chrt_array['tables'][0])
			return true;
		...
		if("filiere" == $this->chrt_array['tables'][0])
			return true;
		if("gestionetudiant_users" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
