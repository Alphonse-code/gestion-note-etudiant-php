...
class XTempl_Base
{
	 ...
	 function __construct( $hideAddedCharts = false )
	{
		...
		{
			$this->assign_function("note_Chart_chart","xt_showchart",array("chartname"=>"note_Chart","table"=>"note Chart","ctype"=>"Combined"));
			$this->assign_function("filiere_Chart_chart","xt_showchart",array("chartname"=>"filiere_Chart","table"=>"filiere Chart","ctype"=>"2DPie"));
		}
