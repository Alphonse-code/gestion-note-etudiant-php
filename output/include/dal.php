...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("gestionetudiant_users");
}
...
class tDAL
{
	var $tblgestionetudiant_at_localhost__controle;
	var $tblgestionetudiant_at_localhost__cycle;
	var $tblgestionetudiant_at_localhost__etudiant;
	var $tblgestionetudiant_at_localhost__filiere;
	var $tblgestionetudiant_at_localhost__gestionetudiant_users;
	var $tblgestionetudiant_at_localhost__matiere;
	var $tblgestionetudiant_at_localhost__niveau;
	var $tblgestionetudiant_at_localhost__note;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "controle", "varname" => "gestionetudiant_at_localhost__controle", "altvarname" => "controle", "connId" => "gestionetudiant_at_localhost", "schema" => "", "connName" => "gestionetudiant at localhost");
		$this->lstTables[] = array("name" => "cycle", "varname" => "gestionetudiant_at_localhost__cycle", "altvarname" => "cycle", "connId" => "gestionetudiant_at_localhost", "schema" => "", "connName" => "gestionetudiant at localhost");
		$this->lstTables[] = array("name" => "etudiant", "varname" => "gestionetudiant_at_localhost__etudiant", "altvarname" => "etudiant", "connId" => "gestionetudiant_at_localhost", "schema" => "", "connName" => "gestionetudiant at localhost");
		$this->lstTables[] = array("name" => "filiere", "varname" => "gestionetudiant_at_localhost__filiere", "altvarname" => "filiere", "connId" => "gestionetudiant_at_localhost", "schema" => "", "connName" => "gestionetudiant at localhost");
		$this->lstTables[] = array("name" => "gestionetudiant_users", "varname" => "gestionetudiant_at_localhost__gestionetudiant_users", "altvarname" => "gestionetudiant_users", "connId" => "gestionetudiant_at_localhost", "schema" => "", "connName" => "gestionetudiant at localhost");
		$this->lstTables[] = array("name" => "matiere", "varname" => "gestionetudiant_at_localhost__matiere", "altvarname" => "matiere", "connId" => "gestionetudiant_at_localhost", "schema" => "", "connName" => "gestionetudiant at localhost");
		$this->lstTables[] = array("name" => "niveau", "varname" => "gestionetudiant_at_localhost__niveau", "altvarname" => "niveau", "connId" => "gestionetudiant_at_localhost", "schema" => "", "connName" => "gestionetudiant at localhost");
		$this->lstTables[] = array("name" => "note", "varname" => "gestionetudiant_at_localhost__note", "altvarname" => "note", "connId" => "gestionetudiant_at_localhost", "schema" => "", "connName" => "gestionetudiant at localhost");
	}
