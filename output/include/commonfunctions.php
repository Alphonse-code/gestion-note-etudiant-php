...
function checkTableName($shortTName, $type=false)
{
	...
	if ("controle" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("cycle" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("etudiant" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("filiere" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("matiere" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("niveau" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("note" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Dashboard" == $shortTName && ($type===false || ($type!==false && $type == 4)))
		return true;
	if ("note_Chart" == $shortTName && ($type===false || ($type!==false && $type == 3)))
		return true;
	if ("filiere_Chart" == $shortTName && ($type===false || ($type!==false && $type == 3)))
		return true;
	if ("gestionetudiant_users" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
...
{
	$arr = array();
	$strPerm = GetUserPermissions("controle");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="controle";
	}
	$strPerm = GetUserPermissions("cycle");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="cycle";
	}
	$strPerm = GetUserPermissions("etudiant");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="etudiant";
	}
	$strPerm = GetUserPermissions("filiere");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="filiere";
	}
	$strPerm = GetUserPermissions("matiere");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="matiere";
	}
	$strPerm = GetUserPermissions("niveau");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="niveau";
	}
	$strPerm = GetUserPermissions("note");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="note";
	}
	...
	$strPerm = GetUserPermissions("note Chart");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="note Chart";
	}
	$strPerm = GetUserPermissions("filiere Chart");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="filiere Chart";
	}
	$strPerm = GetUserPermissions("gestionetudiant_users");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="gestionetudiant_users";
	}
	return $arr;
}
...
{
	if($shorttable=="note_Chart")
		return "Combined";
	if($shorttable=="filiere_Chart")
		return "2DPie";
	return "";
}
...
function GetUserPermissionsStatic( $table )
{
	...
	if($table=="controle" && $sUserGroup=="admin")
	{
...
//	default permissions
	...
	if($table=="cycle" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	...
	if($table=="etudiant" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	...
	if($table=="filiere" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	...
	if($table=="matiere" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	...
	if($table=="niveau" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	...
	if($table=="note" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
...
//	default permissions
	...
	if($table=="note Chart" && $sUserGroup=="admin")
	{
			return "S".$extraPerm;
	}
//	default permissions
	...
	if($table=="filiere Chart" && $sUserGroup=="admin")
	{
			return "S".$extraPerm;
	}
//	default permissions
	if($table=="filiere Chart")
	{
		return "S".$extraPerm;
	}
	if($table=="gestionetudiant_users" && $sUserGroup=="admin")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	if($table=="gestionetudiant_users")
	{
		return "AEDSPI".$extraPerm;
	}
...
function AfterFBLogIn($pUsername, $pPassword, &$pageObject = null)
{
	...
	$strSQL = "select * from ".$connection->addTableWrappers("gestionetudiant_users")
