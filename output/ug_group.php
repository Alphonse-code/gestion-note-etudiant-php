...
$nonAdminTablesArr[] = "controle";
$nonAdminTablesArr[] = "cycle";
$nonAdminTablesArr[] = "etudiant";
$nonAdminTablesArr[] = "filiere";
$nonAdminTablesArr[] = "matiere";
$nonAdminTablesArr[] = "niveau";
$nonAdminTablesArr[] = "note";
$nonAdminTablesArr[] = "Dashboard";
$nonAdminTablesArr[] = "note Chart";
$nonAdminTablesArr[] = "filiere Chart";
$nonAdminTablesArr[] = "gestionetudiant_users";
...
$wGroupTableName = $ug_connection->addTableWrappers( "gestionetudiant_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "gestionetudiant_ugrights" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
		
		$sql = "delete from ".$ug_connection->addTableWrappers( "gestionetudiant_ugmembers" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "gestionetudiant_ugrights" );
	...
	case 'saveMembership':
		...
		$wMemebersTableName = $ug_connection->addTableWrappers( "gestionetudiant_ugmembers" );
