...
$layout = new TLayout("list_bootstrap3", "ExtravaganzaCity", "MobileCity");
$layout->version = 3;
...
$page_layouts["cycle_list"] = $layout;
...
$layout = new TLayout("masterlist_bootstrap", "ExtravaganzaCity", "MobileCity");
$layout->version = 3;
	$layout->bootstrapTheme = "flatly";
...
$page_layouts["filiere_masterlist"] = $layout;
...
$layout = new TLayout("masterchart_bootstrap", "ExtravaganzaCity", "MobileCity");
$layout->version = 3;
	$layout->bootstrapTheme = "flatly";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
$layout->container_properties["column"] = array(  );
$layout->containers["column"][] = array("name"=>"masterchartheader",
	"block"=>"masterlist_title", "substyle"=>1  );
...
$layout->containers["mastergrid"] = array();
$layout->container_properties["mastergrid"] = array(  );
$layout->containers["mastergrid"][] = array("name"=>"bsmasterchart",
	"block"=>"", "substyle"=>1  );

$layout->skins["mastergrid"] = "";

$layout->blocks["bare"][] = "mastergrid";
$page_layouts["filiere_Chart_masterchart"] = $layout;
