...
require_once("include/note_Chart_variables.php");
...
$layout = new TLayout("chart_bootstrap3", "ExtravaganzaCity", "MobileCity");
$layout->version = 3;
...
$page_layouts["note_Chart_chart"] = $layout;
...
$page_layouts["controle_masterlist"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["etudiant_masterlist"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["matiere_masterlist"] = $layout;
