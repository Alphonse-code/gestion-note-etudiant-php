...
$pageMask[$table] = $mask;
$tables[$table] = array("controle", " " . "Controle");
$table = "cycle";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("cycle", " " . "Cycle");
$table = "etudiant";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("etudiant", " " . "Etudiant");
$table = "filiere";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("filiere", " " . "Filiere");
$table = "matiere";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("matiere", " " . "Matiere");
$table = "niveau";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("niveau", " " . "Niveau");
$table = "note";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("note_Chart", " " . "Note Chart");
$table = "filiere Chart";
$mask="";
	$mask .= "S";

$pageMask[$table] = $mask;
$tables[$table] = array("filiere_Chart", " " . "Filiere Chart");
$table = "gestionetudiant_users";
$mask="";
	$mask .= "A";
	$mask .= "E";
	$mask .= "D";
...
$pageMask[$table] = $mask;
$tables[$table] = array("gestionetudiant_users", " " . "Gestionetudiant Users");




$layout = new TLayout("admin_rights_list_bootstrap3", "ExtravaganzaCity", "MobileCity");
$layout->version = 3;
