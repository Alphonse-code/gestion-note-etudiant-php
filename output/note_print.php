...
$layout = new TLayout("print_bootstrap", "ExtravaganzaCity", "MobileCity");
$layout->version = 3;
...
$page_layouts["note_print"] = $layout;
...
$layout = new TLayout("masterprint_bootstrap", "ExtravaganzaCity", "MobileCity");
$layout->version = 3;
	$layout->bootstrapTheme = "flatly";
...
$page_layouts["controle_masterprint"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["etudiant_masterprint"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["matiere_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "note" );
